...
[![License](http://img.shields.io/:license-apache-blue.svg)](http://www.apache.org/licenses/LICENSE-2.0.html) [![Build Status](https://travis-ci.org/simp/pupmod-simp-localusers.svg)](https://travis-ci.org/simp/pupmod-simp-localusers) [![SIMP compatibility](https://img.shields.io/badge/SIMP%20compatibility-4.2.*%2F5.1.*-orange.svg)](https://img.shields.io/badge/SIMP%20compatibility-4.2.*%2F5.1.*-orange.svg)

#### Table of Contents

1. [Description](#description)
2. [Setup - The basics of getting started with localusers](#setup)
...
**FIXME:** Ensure the *What localusers affects* section is correct and complete, then remove this message!
...
**FIXME:** Ensure the *Beginning with localusers* section is correct and complete, then remove this message!
